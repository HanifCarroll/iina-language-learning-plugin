...
const context: ContextSnapshot = {
  selection: {
    ...
    cueStartMs: 4000,
    cueEndMs: 6000,
    cueText: 'Ben öyle bir insan mıyım?',
    rangeStartUtf16: 4,
    rangeEndUtf16: 9,
    exactText: 'öyle '
  },
...
test('initial, follow-up, retry, and stale response ownership', () => {
  // 1. Complete the initial explanation using frozen subtitle context.
  ...
  // 2. Interrupt a follow-up after receiving partial text.
  ...
  // 3. Retry that turn and reject callbacks owned by the interrupted request.
